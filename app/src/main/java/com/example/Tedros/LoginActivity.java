            ...
            public void onResponse(@NonNull Call<LoginResponseModel> call, @NonNull Response<LoginResponseModel> response) {
                ...
                if (responseBody != null) {
                    if (responseBody.getSuccess().equals("1")) {
                        ...
                        editor.putString(Constants.KEY_CNUMBER, responseBody.getUserDetailObject().getUserDetails().get(0).getNumber());
                        editor.putString(Constants.KEY_EMAIL, responseBody.getUserDetailObject().getUserDetails().get(0).getEmail());
                        editor.putString(Constants.KEY_ADDRESS, responseBody.getUserDetailObject().getUserDetails().get(0).getAddress());
                        editor.putString(Constants.KEY_USERID, responseBody.getUserDetailObject().getUserDetails().get(0).getUserid());
                        editor.apply();
                        ...
                        //Toast.makeText(LoginActivity.this,preferences.getString(Constants.KEY_CNUMBER,""),Toast.LENGTH_LONG).show();
